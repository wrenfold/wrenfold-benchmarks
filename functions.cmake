...
function(add_benchmark SOURCE_FILE)
  ...
  target_compile_definitions(${BENCH_NAME} PRIVATE -DNO_FMA)
  ...
  if (NOT MSVC)
    add_executable(${BENCH_NAME}_native_nofma ${SOURCE_FILE})
    add_compilation_options(${BENCH_NAME}_native_nofma)
    target_compile_options(${BENCH_NAME}_native_nofma PRIVATE "-mno-fma" "-march=native")
    target_compile_definitions(${BENCH_NAME}_native_nofma PRIVATE -DNO_FMA)
  endif()
endfunction()
