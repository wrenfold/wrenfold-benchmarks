...
def generate_quat_local_coordinates_first_order(output_dir: T.Optional[T.Openable] = None):
    ...
    inputs = symbolic_inputs(quat_local_coordinates_first_order)
    cg = Codegen(
        inputs,
        outputs=quat_local_coordinates_first_order(**inputs),
        config=CppConfig(),
        name="quat_local_coordinates_first_order",
        return_key=None,
    )
    cg.generate_function(
        output_dir=output_dir,
...
def generate_quat_local_coordinates_chain(output_dir: T.Optional[T.Openable] = None):
    ...
    inputs = symbolic_inputs(quat_local_coordinates_chain)
    cg = Codegen(
        inputs,
        outputs=quat_local_coordinates_chain(**inputs),
        config=CppConfig(),
        name="quat_local_coordinates_chain",
        return_key=None,
    )
    cg.generate_function(
        output_dir=output_dir,
...
def main():
    ...
    if args.profile is None:
        ...
        generate_quat_local_coordinates_chain(output_dir)
        generate_quat_local_coordinates_first_order(output_dir)
    else:
        ...
        time_operation(func=generate_quat_local_coordinates_chain, runs=args.profile)
        time_operation(func=generate_quat_local_coordinates_first_order, runs=args.profile)
